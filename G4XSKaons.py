...
parser.add_argument("fname"   , nargs='?', default = 'KaonPlusG4.txt', type = str, help="insert fileName")
...
gr.SetTitle("K^{+}Ar Cross Section; Kinetic Energy [MeV]; Cross Section [barn]")
